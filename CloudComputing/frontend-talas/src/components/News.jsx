    ...
    return (
        <div className="left">
            ...
            {newsData.slice(0, 5).map(
                (
                    news // Menampilkan 3 berita pertama
                ) => (
    ...
    return (
        <div className="center-section">
            {newsData.slice(0, 1).map(
                (
                    news // Menampilkan 1 berita utama
                ) => (
...
function Headline2() {
    return (
        <div className="headline2">
            {newsData.slice(2, 5).map(
                (
                    news // Menampilkan 2 berita tambahan
                ) => (
...
function BlindZone() {
    return (
        <div className="right-section">
            ...
            {newsData.slice(4, 6).map(
                (
                    news // Menampilkan berita lainnya di kanan
                ) => (
