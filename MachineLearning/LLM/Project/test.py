...
# test_endpoint('cluster', test_data)
# test_endpoint('bias', test_data)
# test_endpoint('hoax', test_data)
# test_endpoint('ideology', test_data)
...
# test_endpoint('title', test_data) 
# test_endpoint('modeCluster', test_data)
# test_endpoint('analyze', test_data)
# test_endpoint('separate', test_data)
# test_endpoint('embedding', test_data)
