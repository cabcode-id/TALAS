...
function RegisterPage() {
    return (
        <div className="flex flex-col items-center justify-center text-black">
            <h1 className="text-2xl font-bold mt-5">Create your free account now</h1>
            ...
            <button className="bg-[#FF8585] text-white w-1/3 py-3 rounded-lg mt-4 hover:bg-[#5a4141]">Sign up</button>
            <div className="flex flex-col w-1/3 text-center mt-1">
                <div className="flex flex-col">
                    <span className="text-gray-500 text-sm">Already have an account? <a href="\login" className="text-blue-500 hover:text-blue-700 hover:underline">Log in</a></span>
                    <a href="\login" className="bg-white text-[#FF8585] py-3 rounded-lg mt-4 hover:bg-[#5a4141] hover:text-white outline-1 outline-gray-400">Log in</a>
